...
//  "/api/company/committees/:ticker/:startYear/:endYear/"
...
module.exports = async (req, res) => {
  ...
  const queryCommittees = `
    SELECT
      a.committee_id,
      b.name,
      b.type AS committee_type,
      b.party_affiliation,
      b.interest_group_category,
    ...
    FROM
      ...
      INNER JOIN fec_raw_committee_master AS b ON a.committee_id = b.id
